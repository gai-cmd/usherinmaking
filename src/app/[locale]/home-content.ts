...
export const HOME: Record<Locale, HomeCopy> = {
  ...
  ko: {
    meta: {
      title: '오키나와 웨딩 스냅 · 가족 촬영',
      description:
        '어셔린메이킹(usherinmaking)은 2014년부터 오키나와에서 스냅 촬영을 이어온 한국인 여성 사진작가입니다. 에메랄드 바다와 오키나와의 자연 속에서 웨딩 · 커플 · 가족 촬영을 진행하며, 상담은 카카오톡으로 편하게 하실 수 있습니다.',
    },
    hero: {
      location: {
        eyebrow: 'OUTDOOR',
    ...
    locationPlans: {
      label: 'WEDDING',
      title: '웨딩 촬영',
      lead: '베이직과 에프터풀, 두 가지 플랜으로 진행합니다. 장소는 그날의 날씨와 빛을 보고 함께 정합니다.',
      aside: 'FROM 88만원',
      notesLabel: '옵션 · 안내',
    ...
    photographer: {
      ...
      body: [
        ...
        '상담부터 촬영까지 처음부터 끝까지 제가 직접 진행하고, 전부 한국어로 편하게 나눕니다.',
      ],
      cta: '작가 소개',
      alt: '오키나와 웨딩 스냅',
    },
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: '자동 예약 기능은 따로 없습니다. 카카오톡이나 인스타그램으로 희망 날짜를 보내주시면 일정을 확인해 안내드립니다.',
        },
        {
          q: '드레스가 포함되나요?',
          a: '의상은 기본 제공되지 않습니다. 신부 드레스는 소품 · 액세서리 포함 10만원부터 대여하실 수 있으며, 디자인과 사이즈는 상담을 통해 정합니다.',
        },
        {
          q: '촬영 장소는 어떻게 정하나요?',
          a: '지역만 미리 정해 두고, 정확한 장소는 촬영일에 임박해 날씨를 보고 추천드립니다. 유명 관광지보다는 한적한 시크릿 스팟 위주로 안내합니다.',
        },
        {
          q: '비가 오면 어떻게 되나요?',
        ...
        {
          q: '한국어로 상담할 수 있나요?',
          a: '네, 카카오톡으로 편하게 문의해 주세요. 인스타그램 DM 으로 남기셔도 한국어로 답변드립니다.',
        },
      ],
    },
...
export const KO_HOME_PLAN_NOTES: string[] = [
  ...
  '헤어/메이크업은 오키나와 현지 숍을 이용하실 수 있습니다 — 기본형 25만원 · 헬퍼형 42만원부터.',
  '주말 · 휴일(일본 기준) 헤어/메이크업 이용 시 추가 요금 +6만원',
  '영상 촬영(기간 한정) — 100초 내외의 편집 영상 제공',
];
