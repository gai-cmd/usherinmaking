...
export const PHOTOS: Photo[] = [
  {
    ...
    takenAt: '2026-06-14',
    terms: ['studio', 'self-wedding', 'arch-window'],
    planCode: 'studio-01',
  ...
  },
  {
    ...
    takenAt: '2026-06-14',
    terms: ['studio', 'self-wedding', 'dress-room'],
    planCode: 'studio-01',
    dress: { ja: 'ホワイト ・ クラシック', en: 'White, classic', ko: '화이트 · 클래식' },
    status: 'PUBLISHED',
  },
  ...
  },
  {
    ...
    takenAt: '2026-04-20',
    terms: ['location', 'self-wedding', 'sunset'],
    planCode: 'location-basic',
    status: 'PUBLISHED',
  },
  {
  ...
  },
  {
    ...
    takenAt: '2026-03-07',
    terms: ['location', 'self-wedding', 'sunny'],
    planCode: 'location-simple',
    status: 'PUBLISHED',
  },
  {
    ...
    takenAt: '2026-02-28',
    terms: ['location', 'wedding', 'remind-wedding', 'sunset'],
    planCode: 'location-basic',
    status: 'PUBLISHED',
  },
  {
